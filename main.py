        ...
        try:
            ...
            for article in state.all_articles.values():
                ...
                records.append({
                    ...
                    'InfluentialCitations': article.influential_citations,
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        for bib in results:
                            ...
                            raw_influential_citations = bib.get('influentialCitationCount')
                            raw_year = bib.get('year')
                            raw_venue = bib.get('venue')
                            raw_publication_date = bib.get('publicationDate')
                            raw_open_access_pdf = bib.get('openAccessPdf')
                            ...
                            if raw_title and (raw_abstract or raw_tldr) and raw_url and raw_citations is not None:
                                ...
                                processed_pdf_url = raw_open_access_pdf['url'] if raw_open_access_pdf else 'None'
...
class ResearchWorkflow:
    ...
    # 6. DeepAnalysisAgent -> elemzés + új kulcsszavak
    # 7. Vissza az 1. pontra az új kulcsszavakkal
