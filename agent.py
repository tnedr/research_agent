...
def search(query):
    # this will give back list of search results from google
...
def scrape_website(objective: str, url: str):
    ...
    # url is the url of the website to be scraped
...
# tests
# result = scrape_website("what is langchain?",
